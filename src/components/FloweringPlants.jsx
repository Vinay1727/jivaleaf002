    ...
    <section className="min-h-screen px-0 py-8 md:py-16 bg-gradient-to-b from-transparent to-green-950/10">
      <div className="max-w-full mx-auto px-4 md:px-8">
        <div className="mb-12 text-center">
          <h2 className="text-2xl md:text-5xl font-bold mb-2 md:mb-4">🌸 Flowering Plants Collection</h2>
          <p className="text-sm md:text-xl text-gray-300 mb-1 md:mb-2">Beautiful blooming flowers for every occasion</p>
          <p className="text-gray-400 text-xs md:text-base">Bring nature's colors to your home</p>
        </div>
        ...
        {!loading && !error && topPlants.length > 0 && (
          <>
            ...
            <div className="mb-8 md:mb-16 p-4 md:p-8 bg-gradient-to-r from-green-900/30 to-emerald-900/30 border border-green-700 rounded-xl md:rounded-2xl">
              <h3 className="text-lg md:text-2xl font-bold mb-4 md:mb-6 text-center">🌟 Top 10 Premium Flowering Plants</h3>
